const input = `...........441.................367................296........................................567..47.....45.................947.............
...
for (let i = 0; i < lines.length; i++){
    let l = lines[i];
    let tokens = l.split(/[^\d]/)
    let s = 0;
    tokens.forEach((t) => {
        let n = parseInt(t)
        if (!isNaN(n)){
            numbers.push({ n, t, r: i, c: s })
        }
        s += t.length + 1
    })
}
...
const sum = numbers.filter((n) => {
    let r1 = Math.max(n.r - 1, 0);
    let r2 = Math.min(n.r + 1, h - 1);
    let c1 = Math.max(n.c - 1, 0);
    let c2 = Math.min(n.c + n.t.length, w - 1);
